...
const zh: Translations = {
  ...
  download_changelog_title: 'v3.0.0 更新内容',
...
const en: Translations = {
  ...
  banner_text:
    'Highlights: Chat / Work / Code modes · 63 → 71 tools · document generation & cloud connectors · Eywa provenance memory',
  banner_link: 'View details',
  banner_close: 'Close banner',

  hero_badge: 'MIT License · v3.0.0 · Personal project',
  hero_title_line1: 'Auraxis Agent',
  ...
  download_subtitle:
    'v3.0.0 · Electron 43 · MIT License. Installers are hosted on GitHub Releases — pick your platform below.',
  ...
  download_changelog_title: "What's new in v3.0.0",
